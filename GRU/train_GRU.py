...
def train_model():
    ...
    no_improve_epochs = 0 # keep track of the number of epochs without any improvement
    ...
    for epoch in range(EPOCHS): # loop over epochs
        ...
        if avg_val_loss < best_val_loss:
            ...
            print(f"No improvement this epoch. Remaining patience: {patience - no_improve_epochs} Epochs")
